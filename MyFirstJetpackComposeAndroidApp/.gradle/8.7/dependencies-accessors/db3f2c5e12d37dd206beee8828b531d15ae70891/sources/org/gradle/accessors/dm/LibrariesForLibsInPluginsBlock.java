...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final PorcupineLibraryAccessors laccForPorcupineLibraryAccessors = new PorcupineLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>ffmpegandroid</b> with <b>com.writingminds:FFmpegAndroid</b> coordinates and
     * with version reference <b>ffmpegandroid</b>
     * <p>
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getFfmpegandroid() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("ffmpegandroid");
    }
    ...
    /**
     * Group of libraries at <b>porcupine</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public PorcupineLibraryAccessors getPorcupine() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForPorcupineLibraryAccessors;
    }
    ...
    public static class FfmpegKitLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>ffmpegKitFull</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class PorcupineLibraryAccessors extends SubDependencyFactory {

        public PorcupineLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>ai.picovoice:porcupine-android</b> coordinates and
         * with version reference <b>porcupineAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("porcupine.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ffmpegKitFull</b> with value <b>4.5.LTS</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ffmpegandroid</b> with value <b>0.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>porcupineAndroid</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPorcupineAndroid() { return getVersion("porcupineAndroid"); }
